    ...
    <div className="grid lg:grid-cols-4 lg:gap-x-28 mx-4 lg:mx-20 my-8">
      ...
      <div className="col-span-3 prose max-w-none w-full flex flex-col">
        <div className="flex flex-col lg:flex-row lg:justify-between">
          <div>
            <h3 className="my-0"><a href="https://www.senecapolytechnic.ca/home.html" className="no-underline hover:text-neutral-400" target="_blank">Seneca Polytechnic</a></h3>
            <h4><a href="https://www.senecapolytechnic.ca/programs/fulltime/CPA.html" className="no-underline hover:text-neutral-400" target="_blank">Computer Programming &amp; Analysis</a></h4>
          </div>
          <div>
